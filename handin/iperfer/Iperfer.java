...
public class Iperfer {
	...
	static private void StartIperfClient() throws Exception
	{
		...
		//Continue to send data in a loop until the specified time is reached
		...
		//Calculate performance statistics, display to user	
	...
	/**
	 * Start the Iperfer server, which receives data in chunks, records total amount received
	 * @throws Exception
	 */
